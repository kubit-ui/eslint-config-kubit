...
module.exports = (options = {}) => {
  ...
  const getTypeScriptRules = () => ({
    ...
    '@typescript-eslint/no-magic-numbers': ['warn', { ignoreTypeIndexes: true }],
  });
  ...
  const getCustomRules = () => ({
    ...
    '@kubit-ui-web/no-index-import/no-index-import': (noIndexImportConfig && Object.keys(noIndexImportConfig).length > 0)
      ? [
          'error',
          {
